...
class School_Portal:
    ...
    def __init__(self, root):
        ...
        Label(frame, text='Amount Paid:').grid(row=7, column=1, sticky=W)
        self.amount = Entry(frame)
        self.amount.grid(row=7, column=2)

        Label(frame, text='Contact:').grid(row=8, column=1, sticky=W)
        self.contact = Entry(frame)
        self.contact.grid(row=8, column=2)        
